        ...
        <form action="envoyerform.php" method="post">
            <div class="row-contact">
                ...
                <div>
                    ...
                    <p><input type="email" id="email" class= "textarea" placeholder="Tapez votre adresse mail"></p>
                    <p><label for="tel">Votre n° de téléphone :</label></p>
                    <p><input type="tel" id="tel" class= "textarea" placeholder="Tapez votre numéro de téléphone"></p>
                ...
                -->
                    ...
                    <!-- Adresse avec API -->
                    <p><label for="adresse">Votre adresse :</label></p>
                    <p><input type="adresse" name="adresse" class= "textarea" placeholder="Tapez votre adresse" id="adresse"></p>
                    <ul id="wrapper"></ul>
                </div>
            </div>
